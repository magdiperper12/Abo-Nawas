...
const Header = () => {
	...
	return (
		<Suspense fallback={<div>Loading...</div>}>
			<header className='backdrop-blur-lg dark:bg-darkprimary/10 bg-white/10 dark:shadow-forth 	 dark:hover:shadow-darksecoundry fixed   w-full pb-2   text-darkprimary  dark:text-white  shadow-lg '>
