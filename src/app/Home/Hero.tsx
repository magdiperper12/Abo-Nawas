				...
				<section className='mt-14 max-w-6xl mx-auto'>
					...
					<div className='grid gap-10 md:grid-cols-3 text-center'>
						{items.map((feature, i) => (
							<motion.div
								key={i}
								className='rounded-xl p-6 border border-darkthird dark:border-darksecoundry bg-pritext-primary   hover:shadow-sm shadow-lg shadow-darkforth dark:shadow-forth dark:hover:shadow-darksecoundry transition'
