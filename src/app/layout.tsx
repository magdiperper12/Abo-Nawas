...
const sukar = Tajawal({ subsets: ["arabic"], weight: "700" });
  ...
  return (
    <html lang="ar">
      <head>
        ...
        <meta name="author" content="أبو نواس | Abo Nawas" />
        <meta name="robots" content="index, follow" />
        <meta
          name="application-name"
          content="أبو نواس لأعمال الحدادة والكريتال"
        />
        <meta name="image" content="https://abonawas.com/favicon.png" />
        <link rel="canonical" href="https://abonawas.com/" />
      ...
      <body
        className={`bg-gradient-to-r relative ${sukar.className}   text-darkprimary dark:text-primary custom-scroll overflow-x-hidden bg-primary dark:bg-darkprimary`}
      >
